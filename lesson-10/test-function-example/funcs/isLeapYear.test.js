/*
1. Give integer number, return true if leap year and false if not.
2. if give wrong data throw error with specific message.
...
describe("test isLeapYear function", ()=> {
    ...
    test("() - 'error must be exist'", ()=> {
        expect(()=> isLeapYear()).toThrow('error must be exist')
    })
